...
var d = !1;
if (
((this.newBuffer = this.newBuffer
? this.newBuffer
: new Uint8Array(n.width * n.height * 4)),
t.readRenderTargetPixels(n, 0, 0, n.width, n.height, this.newBuffer),
this.oldBuffer)
) {
for (var o = 0; o < this.newBuffer.length; o++)
if (this.newBuffer[o] !== this.oldBuffer[o]) {
d = !0;
break;
}
this.oldBuffer = this.newBuffer;
} else (d = !0), (this.oldBuffer = this.newBuffer), (this.newBuffer = null);
this.setChanged(d);
}
this.changed
