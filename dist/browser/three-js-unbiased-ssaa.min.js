...
(n.prototype = Object.assign(Object.create(e.Pass.prototype), {
constructor: n,
dispose: function() {
...
this.renderTarget[n] && this.renderTarget[n].setSize(e, t),
this.renderTargetMean[n] && this.renderTargetMean[n].setSize(e, t);
this.setChanged(!0);
},
createRenderTarget: function(t, n, r, i) {
for (
var a = Math.min(i, 8), s = this.nextRenderIndex % 8, h = 0;
h < Math.min(a, Math.pow(2, this.sampleLevelMax) - this.nextRenderIndex);
h++
) {
var d = r.width,
o = r.height;
...
f = this.jitterOffsets[l + h];
this.camera.setViewOffset &&
this.camera.setViewOffset(d, o, 0.0625 * f[0], 0.0625 * f[1], d, o),
"101" !== e.REVISION &&
console.error(
...
meanCalculation: function(t, n, r, i) {
this.jitterOffsets =
...
a = this.createRenderTarget(t, n, r, a);
...
if (
((this.newBuffer = this.newBuffer || new Uint8Array(r.width * r.height * 4)),
t.readRenderTargetPixels(r, 0, 0, r.width, r.height, this.newBuffer),
this.oldBuffer)
) {
for (var d = 0; d < this.newBuffer.length; d++)
if (this.newBuffer[d] !== this.oldBuffer[d]) {
this.setChanged(!0);
break;
}
var o = this.oldBuffer;
(this.oldBuffer = this.newBuffer), (this.newBuffer = o);
} else
this.setChanged(!0), (this.oldBuffer = this.newBuffer), (this.newBuffer = null);
this.changed
...
: ("101" !== e.REVISION &&
  ...
  t.render(this.sceneQuad, this.cameraQuad, n)),
...
var r = n;
return (
(e.SSAAUnbiasedPass = r),
(e.SSAAUnbiasedShader = t),
{SSAAUnbiasedPass: r, SSAAUnbiasedShader: t}
);
});
