...
` in '@dualbox/three/examples/js/${void 0 !== r ? r + "/" : ""}${a || t}.js'`;
...
g = Math.pow(2, o - 4);
(this.quadCompare.geometry.attributes.uv.array[1] /= g),
(this.quadCompare.geometry.attributes.uv.array[2] /= c),
(this.quadCompare.geometry.attributes.uv.array[3] /= g),
(this.quadCompare.geometry.attributes.uv.array[6] /= c),
(this.materialCompare.defines.WIDTH_STEP = 1 / c),
(this.materialCompare.defines.HEIGHT_STEP = 1 / g),
this.hasChanged(),
...
const a = {SSAAUnbiasedPass: r, SSAAUnbiasedShader: t};
return (
(e.SSAAUnbiasedPass = a.SSAAUnbiasedPass),
(e.SSAAUnbiasedShader = a.SSAAUnbiasedShader),
a
);
});
