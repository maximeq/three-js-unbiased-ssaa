...
createRenderTarget: function(t, n, r, a) {
for (
...
meanCalculation: function(t, n, r, a) {
this.jitterOffsets =
...
i = this.createRenderTarget(t, n, r, i);
...
this.hasChanged(), (this.oldBuffer = this.newBuffer), (this.newBuffer = null);
this.changed
