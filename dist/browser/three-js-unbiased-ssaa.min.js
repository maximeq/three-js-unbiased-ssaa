...
n.width,
n.height,
{minFilter: e.LinearFilter, magFilter: e.NearestFilter, format: e.RGBFormat}
));
...
var d = !1,
o = new Uint8Array(n.width * n.height * 4);
if ((t.readRenderTargetPixels(n, 0, 0, n.width, n.height, o), this.oldBuffer)) {
for (var l = 0; l < o.length; l++)
if (o[l] !== this.oldBuffer[l]) {
d = !0;
break;
}
} else d = !0;
(this.oldBuffer = o), this.setChanged(d);
}
this.changed
