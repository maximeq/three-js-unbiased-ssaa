...
? (module.exports = t(require("@dualbox/three")))
: "function" == typeof define && define.amd
? define(["@dualbox/three"], t)
...
fragmentShader: s.fragmentShader.replace(
/NUMBER_TEXTURE/g,
Math.pow(2, h).toString()
)
});
...
vertexShader: s.vertexShader,
fragmentShader: s.fragmentShader.replace(/NUMBER_TEXTURE/g, "8")
})),
...
createRenderTarget: function(t, r, a, n) {
for (
var i = Math.min(n, 8), s = this.nextRenderIndex % 8, h = 0;
...
t.setRenderTarget(this.renderTarget[h + s]),
t.clear(),
...
meanCalculation: function(t, r, a, n) {
this.jitterOffsets =
e.SSAAUnbiasedPass.JitterVectors[Math.max(0, Math.min(n, 5))];
for (
var i = this.changed
...
i = this.createRenderTarget(t, r, a, i);
...
this.quad.material = this.material[this.changed ? n : Math.trunc(Math.log2(s))];
...
var d = Math.ceil(Math.log2(a.width)),
o = Math.ceil(Math.log2(a.height)),
l = Math.pow(2, d),
u = Math.pow(2, o);
this.newRender =
this.newRender ||
...
var g = Math.pow(2, d - 4),
c = Math.pow(2, o - 4);
(this.quadCompare.geometry.attributes.uv.array[1] /= c),
(this.quadCompare.geometry.attributes.uv.array[2] /= g),
(this.quadCompare.geometry.attributes.uv.array[3] /= c),
(this.quadCompare.geometry.attributes.uv.array[6] /= g),
(this.materialCompare.defines.WIDTH_STEP = 1 / g),
...
if (
(this.changed
? ((n = this.sampleLevelMin),
  (this.finalRenderDone = !1),
  (this.nextRenderMeanIndex = 0))
: (n = this.sampleLevelMax),
this.finalRenderDone ||
(this.meanCalculation(t, r, a, n),
...
var a = r;
return (
(e.SSAAUnbiasedPass = a),
(e.SSAAUnbiasedShader = t),
{SSAAUnbiasedPass: a, SSAAUnbiasedShader: t}
);
});
