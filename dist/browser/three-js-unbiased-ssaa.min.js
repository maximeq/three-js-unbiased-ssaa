...
a = Math.pow(2, Math.ceil(Math.log2(t)));
(this.newRender.width === n && this.newRender.height === a) ||
(this.newRender.setSize(n, a),
this.renderTargetCompare && this.renderTargetCompare.setSize(n, a),
this.oldRender && this.oldRender.setSize(n, a),
this.buffer && (this.buffer = new Uint8Array(n * a * 4)));
}
this.hasChanged();
},
...
t.readRenderTargetPixels(this.renderTargetCompare, 0, 0, d, o, this.buffer);
